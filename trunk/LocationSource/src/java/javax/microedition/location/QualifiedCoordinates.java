	...
	extends Coordinates
{
	...
	public void setHorizontalAccuracy (float horizontalAccuracy)
	{
		...
		{
			// This is how the JNI signals no value available.
	...
	public void setVerticalAccuracy (float verticalAccuracy)
	{
		...
		{
			// Can get a vertical accuracy without any altitude from the GPSID.
			this.verticalAccuracy = Float.NaN;
		}
		else if ( Float.isNaN(verticalAccuracy) || (verticalAccuracy >= 0.0F) )
		{
