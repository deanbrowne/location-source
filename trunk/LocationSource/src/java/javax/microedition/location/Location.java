...
{
	// Note there is a bug in the IBM WEME 6.1 JVM that forces this to be an
	// abstract class instead of an interface like the JSR-179 specification.
	// As an interface the JVM hangs when these methods are called from within
	// a LocationListener.locationUpdated implementation in another package.
